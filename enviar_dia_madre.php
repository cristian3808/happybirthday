...
$sql_usuarios = "SELECT email FROM usuarios WHERE genero = 'femenino' AND tiene_hijos = 'si'";
...
foreach ($usuarios as $usuarioEmail) {
    ...
    $sql_verificar = "SELECT * FROM envios_dia_madre WHERE usuario_email = '$usuarioEmail' AND fecha_envio = '$hoy'";
    ...
    try {
        ...
        $imagenMadre = generarImagen("Feliz Día, Compañera");
        $mail->addEmbeddedImage($imagenMadre, 'imagenMadre', 'dia_madre.png');
        ...
        <body style='font-family: Arial, sans-serif; color: #333; padding: 20px;'>
            <p style='font-size: 18px; line-height: 1.5;'>
                ...
                En nombre de <strong>TF Auditores y Asesores</strong>, queremos expresarte nuestra admiración y gratitud en este día tan especial.<br><br>
                <span style='font-size: 20px;'>🌷 ¡FELIZ DÍA DE LA MADRE! 💖</span><br>
                Gracias por tu amor, fortaleza y entrega constante. Hoy celebramos tu papel invaluable en nuestras vidas.
            </p>
            <div style='text-align: center; margin-top: 20px;'>
                <img src='cid:imagenMadre' alt='Feliz Día de la Madre' style='max-width: 380px; width: 100%; border-radius: 12px;' />
            </div>
        </body>
        </html>
        ";
        ...
        $sql_insertar = "INSERT INTO envios_dia_madre (usuario_email, fecha_envio) VALUES ('$usuarioEmail', '$hoy')";
...
function generarImagen($nombreCompleto) {
    $imagePath = __DIR__ . "/static/img/Día de la madre.png";
    ...
    $imagePathOutput = __DIR__ . "/static/img/dia_madre_" . str_replace(" ", "_", $nombreCompleto) . ".png";
