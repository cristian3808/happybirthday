...
$sql_usuarios = "SELECT email FROM usuarios WHERE genero = 'masculino' AND tiene_hijos = 'si'";
...
foreach ($usuarios as $usuarioEmail) {
    ...
    $sql_verificar = "SELECT * FROM envios_dia_padre WHERE usuario_email = '$usuarioEmail' AND fecha_envio = '$hoy'";
    ...
    try {
        ...
        $mail->Subject = "¡Felicidades, querido compañero!";
        // Genera la imagen para el correo
        $imagenPadre = generarImagen("Feliz Día, Compañero");
        $mail->addEmbeddedImage($imagenPadre, 'imagenPadre', 'dia_padre.png');
        ...
        <body style='font-family: Arial, sans-serif; color: #333; padding: 20px;'>
            <p style='font-size: 18px; line-height: 1.5;'>
                ...
                En nombre de <strong>TF Auditores y Asesores</strong>, queremos rendirte un homenaje muy especial.<br><br>
                <span style='font-size: 20px;'>👨‍👧‍👦 ¡FELIZ DÍA DEL PADRE! 💙</span><br>
                Gracias por tu dedicación, esfuerzo y amor incondicional. Hoy celebramos el gran rol que desempeñas.
            </p>
            <div style='text-align: center; margin-top: 20px;'>
                <img src='cid:imagenPadre' alt='Feliz Día del Padre' style='max-width: 580px; width: 100%; border-radius: 12px;' />
            </div>
        </body>
        </html>
        ";
        ...
        $sql_insertar = "INSERT INTO envios_dia_padre (usuario_email, fecha_envio) VALUES ('$usuarioEmail', '$hoy')";
...
function generarImagen($nombreCompleto) {
    $imagePath = __DIR__ . "/static/img/Día del padre.png";
    ...
    $imagePathOutput = __DIR__ . "/static/img/dia_padre_" . str_replace(" ", "_", $nombreCompleto) . ".png";
