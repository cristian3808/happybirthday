...
$sql_usuarios = "SELECT email FROM usuarios WHERE genero = 'masculino'";
...
foreach ($usuarios as $usuarioEmail) {
    ...
    $sql_verificar = "SELECT * FROM envios_dia_hombre WHERE usuario_email = '$usuarioEmail' AND fecha_envio = '$hoy'";
    ...
    try {
        ...
        $mail->addEmbeddedImage($imagenCumple, 'imagenCumple', 'dia_hombre.png');
       ...
       <body style='font-family: Arial, sans-serif; color: #333; padding: 20px;'>
            <p style='font-size: 18px; line-height: 1.5;'>
                ...
                <span style='font-size: 20px;'>¡FELIZ DÍA DEL HOMBRE👔🎩💼!</span>
            </p>
            <div style='text-align: center; margin-top: 20px;'>
                <img src='cid:imagenCumple' alt='Feliz Día' style='max-width: 380px; width: 100%; border-radius: 12px;' />
            </div>
        </body>
        </html>
        ";
...
function generarImagen($nombreCompleto) {
    $imagePath = __DIR__ . "/static/img/azull.png";
    ...
    $imagePathOutput = __DIR__ . "/static/img/dia_hombre_" . str_replace(" ", "_", $nombreCompleto) . ".png";
